...
{
public:
  //this constructor creates a class
  udp_service_provider(std::shared_ptr<boost::asio::io_service> io_service, std::shared_ptr<boost::asio::ip::udp::socket> socket,
  ...
  udp_service_provider(std::shared_ptr<boost::asio::io_service> io_service, std::shared_ptr<boost::asio::ip::udp::socket> socket, std::string expected_message);
...
private:
  ...
  std::unique_ptr<std::thread> message_receiver_thread;
